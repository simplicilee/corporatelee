+function ($) {
  'use strict';
    ...
    SelectSplitter.prototype.init = function (type, element, options) {
        ...
        self.$wrapper = self.$element.next('div[data-selectsplitter-wrapper-selector]'); // improved by simplicilee
        self.$firstSelect = $('select[data-selectsplitter-firstselect-selector]', self.$wrapper); // improved by simplicilee
        self.$secondSelect = $('select[data-selectsplitter-secondselect-selector]', self.$wrapper); // improved by simplicilee
        ...
        if (self.options.selectSize) {
            selectSize = self.options.selectSize; // improved by simplicilee
        }
